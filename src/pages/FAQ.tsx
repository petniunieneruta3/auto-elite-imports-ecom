  ...
  const faqs = [
    {
      ...
      answer: "Der Kaufprozess ist einfach: Wählen Sie Ihr Fahrzeug aus, kontaktieren Sie uns für Details, vereinbaren Sie eine Besichtigung (optional), schließen Sie den Kaufvertrag ab und wir organisieren die Lieferung. Wir kümmern uns um alle Importformalitäten bis zur Lieferung zu Ihnen nach Hause. Die Lieferzeit beträgt 5 Tage."
    },
    {
    ...
    {
      question: "Welche Zahlungsmodalitäten bieten Sie an?",
      answer: "Anzahlung: 20% bei Bestellung. Der Restbetrag ist bei Lieferung fällig oder kann in zinslosen Raten von 6 bis 84 Monaten bezahlt werden. Sonderangebot: -10% Rabatt bei Barzahlung bei Bestellung. Sie haben außerdem ein 14-tägiges Widerrufsrecht (Zufrieden oder Geld zurück)."
    },
    {
      question: "Ist eine Finanzierung möglich?",
      answer: "Ja, wir arbeiten mit verschiedenen Finanzpartnern zusammen und bieten flexible Finanzierungsoptionen, einschließlich Leasing und Ratenkauf mit zinslosen Raten von 6 bis 84 Monaten."
    },
    {
      question: "Liefern Sie europaweit?",
      answer: "Ja, wir liefern in ganz Europa. Die Lieferkosten variieren je nach Zielort. Kontaktieren Sie uns für ein individuelles Angebot. Die Lieferzeit beträgt in der Regel 5 Tage."
    },
    {
